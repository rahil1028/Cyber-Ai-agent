...
<div class="wrap section" id="pricing">
    ...
    <div class="grid-3">
        ...
        <div class="feature-card" style="border-color:var(--accent);position:relative">
            ...
            <button class="btn-primary btn-full" onclick="window.location.href='mailto:nasimrahil48@gmail.com?subject=CyberLens%20AI%20Pro%20-%20Early%20Access'">Get early access</button>
        </div>
        <div class="feature-card">
            <h3>Agency</h3>
                ...
                <div class="scan-controls">
                    <div>
                        ...
                        <select id="scanProfile">
                            ...
                            <option value="safe_active" disabled>Safe active assessment (coming soon)</option>
                        </select>
                    </div>
