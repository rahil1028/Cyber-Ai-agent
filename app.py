...
<div class="nav"><div class="logo">ðŸ›¡ï¸ Cyber<span class="grad">Lens</span> AI</div><span class="badge">Powered by Gemini</span></div>
...
<button onclick="showAuth()">Get Started â†’</button></div><div class="card shield">ðŸ›¡ï¸</div></section>
