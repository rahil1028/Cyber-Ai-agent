...
<div class="wrap section" id="grc">
    <div class="section-head">
        ...
        <h2>Findings mapped to the frameworks you're measured against</h2>
        <p>CyberLens AI isn't a certification body — but every finding is written with common GRC frameworks in mind, so your team can connect technical results to the controls that matter.</p>
    </div>
    <div class="grid-4">
        <div class="feature-card">
            <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M9 12l2 2 4-4m5-2v4c0 5-3.4 8.5-8 9.5-4.6-1-8-4.5-8-9.5V8l8-3.5L18 8z" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
            <h3>ISO/IEC 27001</h3>
            <p>Findings reference relevant Annex A control areas (access control, cryptography, operations security) to support your ISMS evidence gathering.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3v3m0 12v3m9-9h-3M6 12H3m14.5-6.5l-2 2m-9 9l-2 2m13-2l-2-2m-9-9l-2-2" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="12" r="3.2" stroke="currentColor" stroke-width="1.8"/></svg></div>
            <h3>OWASP Top 10</h3>
            <p>Web application findings are categorized with CWE references that map cleanly onto OWASP's Top 10 risk categories.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="4" y="10" width="16" height="10" rx="2" stroke="currentColor" stroke-width="1.8"/><path d="M8 10V7a4 4 0 018 0v3" stroke="currentColor" stroke-width="1.8"/></svg></div>
            <h3>SOC 2 readiness</h3>
            <p>Transport security, access control, and logging-related findings feed directly into common SOC 2 Trust Service Criteria discussions.</p>
        </div>
        <div class="feature-card">
            <div class="feature-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M4 6h16M4 12h16M4 18h10" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg></div>
            <h3>GDPR / DPDP awareness</h3>
            <p>Data-exposure findings (open files, weak transport security) are flagged with the kind of data-protection impact auditors look for.</p>
        </div>
    </div>
    <p class="muted" style="margin-top:18px;font-size:12px">Note: CyberLens AI provides technical security findings to support your compliance process — it does not issue certifications or replace a formal audit.</p>
</div>
